<template>
  <v-container>
      Datatable goes here...
        ...
        <v-list>
          <v-list-item :value="true" v-for="(item, i) in items" :key="item.title">
            <v-list-item-action>d
...
export default {
  data: () => ({
    ...
    watch: {
       ...
       mounted: function () {
        const accountId = "d3b33f08-66ac-409a-8a3e-771682d4576a";
        const appId = "d96f1fba8eac44718323296f11c3b227";
        let hamoni;
